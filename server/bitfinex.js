...
async function getFrrRateList(ccy = DEFAULT_CCY) {
  let url=`/funding/stats/f${ccy}/hist`

  return await client._makePublicRequest(url, {})
}
...
async function submitFundingOffer({
  ...
  return client.submitFundingOffer(
    ...
    console.log(`submit funding offer  is error. ${error}`)
  });
}
